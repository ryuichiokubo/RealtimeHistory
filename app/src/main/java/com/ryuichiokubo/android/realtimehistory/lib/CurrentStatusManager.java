...
public final class CurrentStatusManager {
	...
	static {
		...
		// TODO more daily events and randomness
		...
		map.put(10, R.string.geography);
		map.put(11, R.string.classic);
		map.put(12, R.string.lunch);
		map.put(13, R.string.history);
		map.put(14, R.string.shopping);
		map.put(15, R.string.shopping);
		map.put(16, R.string.kabuki);
		map.put(17, R.string.kabuki);
		map.put(18, R.string.dinner);
		map.put(19, R.string.bath);
		map.put(20, R.string.reading);
		map.put(21, R.string.reading);
